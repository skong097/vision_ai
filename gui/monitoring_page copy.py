...
✅ 상태: 웹캠 + YOLO Pose + Skeleton + 낙상 감지 + 미러링
"""
...
class MonitoringPage(QWidget):
    ...
    def start_monitoring(self):
        ...
        try:
            ...
            self.add_log("[INFO] 모니터링 시작 (20 FPS)")
